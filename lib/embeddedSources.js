...
/**
 * Third-party embeds are sandboxed by default, which blocks the pop-up/pop-under
 * ads these hosts inject while leaving playback intact. Set
 * NEXT_PUBLIC_PLAYER_SANDBOX=off if a provider ever needs full access.
 */
export const PLAYER_SANDBOX =
  process.env.NEXT_PUBLIC_PLAYER_SANDBOX === "off"
    ? undefined
