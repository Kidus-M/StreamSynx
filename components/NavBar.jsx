            ...
            <div className={`fixed inset-0 bg-black bg-opacity-50 z-50 transform ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300`}>
                <div className="w-64 h-full bg-primary p-6 shadow-lg">
                    ...
                    <ul className="flex flex-col mt-10 space-y-6">
                        <li><a href="#" className="text-lg text-secondary cursor-pointer hover:text-tertiary">Home</a></li>
                        <li><a href="#" className="text-lg text-secondary cursor-pointer hover:text-tertiary">Watch Later</a></li>
                        <li><a href="#" className="text-lg text-secondary cursor-pointer hover:text-tertiary">Watch History</a></li>
                        <li><a href="#" className="text-lg text-secondary cursor-pointer hover:text-tertiary">Favorites</a></li>
                        <li><a href="#" className="text-lg text-secondary cursor-pointer hover:text-tertiary">Watch Buddies</a></li>
                    </ul>
                    ...
                    <div className="absolute bottom-6 left-6 flex items-center space-x-4 hover:text-secondary cursor-pointer">
                        ...
                        <a href="#" className="text-lg text-secondary">Profile</a>
                    </div>
                </div>
            </div>
